    ...
    questions: [
      {
        ...
        subQuestions: [
          {
            id: 'pp-gs-2016-1-q2a',
            questionText: '(a) What were the main objectives of Clean Development Mechanism? Also explain the reasons for the criticism on Koyoto Protocol by the developed countries.',
          ...
          {
            id: 'pp-gs-2016-1-q2b',
            questionText: '(b) Differentiate between Sanitary and Industrial Landfills, also describe the land selection criteria for Landfills.',
      ...
      },
      {
        ...
        subQuestions: [
          {
            id: 'pp-gs-2016-1-q3a',
            questionText: '(a) Write a short note on artificial intelligence.',
          ...
          {
            id: 'pp-gs-2016-1-q3b',
            questionText: '(b) Write short notes on: (i) Fibre Optics (ii) Global Positioning System',
      ...
      },
      {
        ...
        subQuestions: [
          {
            id: 'pp-gs-2016-1-q4a',
            questionText: '(a) What are vaccines? Classify these and discuss DNA vaccines in detail.',
          ...
          {
            id: 'pp-gs-2016-1-q4b',
            questionText: '(b) What are causative organism and vector for dengue, enlist possible ways of prevention from dengue.',
      ...
      },
      {
        ...
        subQuestions: [
          {
            id: 'pp-gs-2016-1-q5a',
            questionText: '(a) Comment, ‘liver is the chief chemist in human body’.',
          ...
          {
            id: 'pp-gs-2016-1-q5b',
            questionText: '(b) What is Cholesterol? Discuss its importance, normal blood level and dangers of elevated levels with reference to the health and disease in humans.',
      ...
      },
      {
        ...
        subQuestions: [
          {
            id: 'pp-gs-2016-1-q6a',
            questionText: '(a) What do you know about the Remote Sensing Techniques? Explain resolution and write down the names of its various types?',
          ...
          {
            id: 'pp-gs-2016-1-q6b',
            questionText: '(b) What is hydrological cycle? Discuss its importance.',
      ...
      },
      {
        ...
        subQuestions: [
          {
            id: 'pp-gs-2016-1-q7a',
            questionText: '(a) What is tsunami? How the tsunamis generated and what are their characteristics?',
          ...
          {
            id: 'pp-gs-2016-1-q7b',
            questionText: '(b) What is an earth quake? Discuss Richter Scale in this context. What was the intensity of the earth quake in Pakistan dated 26 October 2015 and where was the locus?',
      ...
      },
      {
        ...
        subQuestions: [
          {
            id: 'pp-gs-2016-1-q8a',
            questionText: '(a) Explain the shape of water molecule with the help of Molecular Orbital Theory, also draw its orbital diagram.',
          ...
          {
            id: 'pp-gs-2016-1-q8b',
            questionText: '(b) What are the gamma rays? Explain their applications.',
      ...
      },
      {
        ...
        subQuestions: [
          {
            id: 'pp-gs-2016-1-q9a',
            questionText: '(a) Discuss importance of preservatives and antioxidants in food.',
          ...
          {
            id: 'pp-gs-2016-1-q9b',
            questionText: '(b) Comment, Green House Effect is a blessing. Also discuss Enhanced Green House Effect and its relation with global warming.',
        ...
        subQuestions: [
          {
            ...
            questionText: '(a) Define and draw the following: (i) Rightangle triangles (ii) Equilateral triangles',
          ...
          },
          {
            ...
            questionText: '(b) There are nine students in a group having ages 15, 15, 16, 16, 16, 17, 17, 18, 19. Calculate mean, medium, mode and range of their ages also define the above mentioned terms:',
        ...
        subQuestions: [
          {
            ...
            questionText: '(a) Differentiate between primary and secondary mental abilities. How the general mental ability scales differ from IQ test.',
          ...
          },
          {
            ...
            questionText: '(b) Y = mX + C is an equation of straight line. Draw a graph showing relationship between X and Y and relate the equation to the slope and intercept on the graph.',
    ...
    questions: [
        {
            ...
            idealAnswer: 'Weather describes short-term atmospheric conditions (e.g., daily temperature, rain). Climate describes the long-term average of weather patterns in a region, typically over 30 years. In essence, "climate is what you expect, weather is what you get."',
        }
    ]
  },
  {
