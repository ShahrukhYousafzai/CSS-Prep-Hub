...
export const pastPapers: PastPaperQuestion[] = [
  {
    ...
    questionText: 'Explain the purpose of the International Financial Reporting Standards (IFRS) and their role in global business.',
    idealAnswer: 'The purpose of IFRS is to provide a single set of high-quality, globally accepted accounting standards. Their role is to increase transparency and comparability of financial information across international boundaries, which helps investors and other stakeholders make informed economic decisions.',
  },
  {
    id: 'pp-econ-2023-p1',
    year: 2023,
