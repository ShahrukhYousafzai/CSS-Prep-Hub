        ...
        questions: [
            {
                id: 'pp-gpp-2016-1-q1',
                questionType: 'Other',
                questionText: '(a) Define Public Policy and state its significance.\n(b) Discuss the Role of Planning Commission in policy and Planning.',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2016-1-q2',
                questionType: 'Other',
                questionText: 'Do you support the representation of public opinion information diffusion in the policy making process? Support your answer with valid justification in the context of policy advocacy.',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2016-1-q3',
                questionType: 'Other',
                questionText: 'Draw a clear demarcation between Policy Analysis and Policy Advocacy.',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2016-1-q4',
                questionType: 'Other',
                questionText: 'Discuss Policy Formation and Implementation Issues in Pakistan.',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2016-1-q5',
                questionType: 'Other',
                questionText: 'Define Global Governance. Discuss its significance and explain the emergent need of growing interdependence between international states in global context.',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2016-1-q6',
    ...
    },
    {
        ...
        questions: [
            ...
            },
            {
                id: 'pp-gpp-2018-1-q3',
                questionType: 'Other',
                questionText: 'The planning Commission (PC) is an apex financial and public policy making institution of the Government of Pakistan. Elaborate the role of PC in terms of policy development for national economic growth and development of social infrastructure through the Public Sector Development Programs (PSDP).',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2018-1-q4',
            ...
            },
            {
                id: 'pp-gpp-2018-1-q6',
                questionType: 'Other',
                questionText: 'Federal character of Pakistan’s government is enshrined in its 1973 constitution. 18th constitutional amendment enhanced political and fiscal space for Pakistan’s constituent units. Highlight key features of 18th constitutional amendment and explain its significance for the smaller provinces of Pakistan.',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2018-1-q7',
                questionType: 'Other',
                questionText: 'According to the new public management model, the role of citizens in enhancing governance of public sector is critically important. Explain how civil society − an instrumental pillar of the state − can potentially transform the outcomes of governance for the benefit of citizenry.',
                idealAnswer: 'To be provided by AI.'
            }
        ]
    },
        ...
        questions: [
            {
                id: 'pp-gpp-2019-1-q1',
                questionType: 'Other',
                questionText: 'Identify the main differences between ‘public management’ and ‘private management’; and between ‘public governance’ and ‘corporate governance’.',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2019-1-q2',
                questionType: 'Other',
                questionText: 'In many areas, governments increasingly have been moving toward partnership working across public and private sector. What are the main governance implications of this trend for the delivery of public services?',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2019-1-q3',
                questionType: 'Other',
                questionText: 'Discuss the ways in which the legislative and judicial branches interact with the bureaucracy. Explain why these interventions are necessary and useful?',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2019-1-q4',
                questionType: 'Other',
                questionText: 'How can bureaucrats and bureaucracies be held accountable? By whom and by what means can they be held accountable? Describe the steps and the measures that can be taken to increase bureaucratic accountability. How do the judicial, the executive, and the legislative branches of government hold bureaucrats and bureaucracies accountable?',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2019-1-q5',
                questionType: 'Other',
                questionText: 'Choose a policy issue and examine it in the light of policy cycle. Be sure to discuss the relevance of each of the following in your answer: agenda setting, policy formulation, policy adoption, policy implementation, policy evaluation, policy change and policy termination. Also, discuss the most important considerations at each step.',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2019-1-q6',
                questionType: 'Other',
                questionText: 'What are the advantages and disadvantages of a federal system of governments?',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2019-1-q7',
        ...
        questions: [
            {
                id: 'pp-gpp-2020-1-q1',
                questionType: 'Other',
                questionText: 'Kerala’s (India) governing model presents a theory of decentralized development. Critically evaluate the strengths and weaknesses of this experience in Kerala. What is the feasibility for its adoption in your province in Pakistan?',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2020-1-q2',
                questionType: 'Other',
                questionText: 'What are the similarities and differences of thoughts on Bureaucracy by Woodrow Wilson and Max Weber? Draw out a link between their thoughts and the political system that both had experienced in their countries?',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2020-1-q3',
                questionType: 'Other',
                questionText: 'What are the roles of bureaucracy in the various stages of public policy process from problem identification/definition to policy change/termination?',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2020-1-q4',
                questionType: 'Other',
                questionText: 'Describe the evolution of the paradigm of governance from Wilsonian concept of the dichotomy of politics and administration to the contemporary fusion of both.',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2020-1-q5',
    ...
    },
    {
        ...
        questions: [
            ...
            },
            {
                id: 'pp-gpp-2021-1-q2',
                questionType: 'Other',
                questionText: 'Various scholars attend to the interaction between politics and markets to explain the way welfare states undertake social provision, including providing for education (aka “human capital acquisition”), providing welfare benefits, work-family policies, and more. Take two or more such analyses and explain with some care how political and market-based approaches help us understand how social policies develop. Which approaches do you find most resonant to your own thinking, and why?',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2021-1-q3',
                questionType: 'Other',
                questionText: 'Explain the concept of Pareto efficiency. What is its relevance to policy analysis, given that it is an abstract benchmark unlikely to be achieved by most policies that are subject to debate? Continue by explaining the Kaldor-Hicks compensation principle and its significance to rational policy analysis – in particular, the practice of cost/benefit analysis. What makes the Kaldor-Hicks compensation principle a “weaker” criterion to satisfy than the Pareto criterion? Do you think Kaldor-Hicks is a sound basis for making policy decisions; why or why not?',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2021-1-q4',
                questionType: 'Other',
                questionText: 'How are problems in society addressed through public policy? How do they get on the policy agenda? Discuss the primary stakeholders and their interests in the process. Provide real life case examples as part of your answer.',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2021-1-q5',
                questionType: 'Other',
                questionText: 'Define, explain and contrast the politics of interest and the politics of conscience and how they influence policy making in Pakistan, including their relationship to the application of ethics. Be sure to include examples in your response and discuss the difficulty in identification and application of these influences within and between political parties',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2021-1-q6',
                questionType: 'Other',
                questionText: 'How does an issue become part of the public policy “agenda”? Out of all the issues that exist, why do some come to legislative attention and many do not? Consider the classic “Garbage Can Model” of Cohen, March and Olsen (1972). Do you agree or disagree? Why?',
                idealAnswer: 'To be provided by AI.'
            },
            {
                id: 'pp-gpp-2021-1-q7',
